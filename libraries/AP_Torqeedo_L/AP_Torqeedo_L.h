...
#include "AP_Torqeedo_config_L.h"
...
class AP_Torqeedo_L : public AP_ESC_Telem_Backend {
public:
    AP_Torqeedo_L();

    CLASS_NO_COPY(AP_Torqeedo_L);

    static AP_Torqeedo_L* get_singleton();
...
private:
    ...
    static AP_Torqeedo_L *_singleton;

...
void AP_BattMonitor_Torqeedo_R::read(void)
{
    AP_Torqeedo_R *torqeedo = AP_Torqeedo_R::get_singleton();
    if (torqeedo == nullptr) {
...
bool AP_BattMonitor_Torqeedo_R::capacity_remaining_pct(uint8_t &percentage) const
{
    if (have_info) {
